...
class ArtistsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasfile('artistPath')) {
            ...
            $path = $request->file('artistPath')->store('artists_images', 'public');
    ...
    public function update(Request $request, string $id)
    {
        ...
        if ($request->hasfile('artistPath')) {
           ...
           // $request->file('artistPath')->move(public_path($path), $filename);
            ...
            if (file_exists(storage_path($content_to_update->photoPath))) {
                unlink(storage_path($content_to_update->photoPath));
            }
