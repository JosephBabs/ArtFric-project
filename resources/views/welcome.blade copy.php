            ...
            <div class="row d-flex  align-items-start">
                <div class="col-md-12">
                    <div class="banner-slider">
                        <div class="slide">
                            <img src="{{asset('storage/arts_images/pexels-steve-johnson-1509534.jpg')}}" alt="Slide 1">
                            <div class="caption">Unveiling the Soul of Africa: <br> Delve into the captivating world<br> of African arts and stories.</div>
                        </div>
                        <div class="slide">
                            <img src="{{asset('storage/arts_images/pexels-steve-johnson-1269968.jpg')}}" alt="Slide 1">
                        ...
                        <div class="slide">
                            <img src="{{asset('storage/arts_images/pexels-daian-gan-102127.jpg')}}" alt="Slide 2">
    ...
    <section class="space-md">
        ...
        <div class="section" id="featured-artworks">
            ...
            <div class="cards-grid">
                @foreach($arts as $art)
                <div class="card">
                    <a href="{{route('art.show', $art->id)}}"><img src="{{asset('storage/'.$art->artPath)}}" alt="{{$art->title}}">
                        <h3>{{$art->title}}</h3>
                    </a>
                    <p>{{$art->description}}</p>
                </div>
        ...
        <div class="section" id="artists">
            ...
            <div class="cards-grid">
                ...
                <div class="card">
                    <a href="{{route('artist.show', $artist->id)}}"><img src="{{asset('storage/'.$artist->photoPath)}}" alt="{{$artist->firstname . ' '. $artist->lastname}}">
            ...
            <div class="cards-grid">
                ...
                <div class="card col-lg-8 col-md-8 col-sm-8" style="height:100%">
                    ...
                    <div class="event-description">
                        <img src="{{asset('storage/'.$event->imagePath)}}" style="width:100%; height:100%; position:relative">
