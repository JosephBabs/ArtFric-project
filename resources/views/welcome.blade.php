...
@section('main')
                    ...
                    <div class="section card tab-content" id="tabContent1"
                        ...
                        <div class="cards-grid">
                            <div class="row mt-3" style="">
                                @foreach ($arts as $art)
                                    <div class="card " style="width: 17rem; margin: 8px; background-image: url('../assets/img/curved-images/white-curved.jpeg'); background-repeat:no-repeat; background-size:cover " >
                                ...
                                <div class=" h-100 p-3" style="width: 20rem; margin: 0px;">
                                    <div class="overflow-hidden  shadow position-relative border-radius-lg bg-cover h-100"
                                        ...
                                        <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                                            <h6 class="text-white card font-weight-vold mb-4 pt-2 p-1 bg-gradient-primary shadow">{{ $event->date }}</h6>
                                            <h5 class="text-white font-weight-bolder mb-4 pt-2">{{ $event->title }}</h5>
                                            <p class="text-white">{{ Illuminate\Support\Str::limit($event->description, 40) }}</p>
                                            <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto openPopupBtn" data-event="{{ $event->id }}"
                                                href="javascript:;" data-toggle="modal" data-target="#bidevent">
                                                Bid
    ...
    <div class="modal fade" id="bidevent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
